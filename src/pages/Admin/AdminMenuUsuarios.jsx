            ...
            <div className="row mb-5">
                <div className="col-sm-6 mb-5 fade-in-card">
                    <div className="single-program wow fadeIn p-4" data-wow-duration=".5s" data-wow-delay=".1s">
                        ...
                        <Link to="/AgregarUsuario" style={{ textDecoration: 'none' }}><Button type="button" className="w-75 btn BotonesColor"><FontAwesomeIcon icon={faArrowRight} /></Button></Link>
                    </div>
                </div>
                <div className="col-sm-6 mb-5 fade-in-card">
                    <div className="single-program wow fadeIn p-4" data-wow-duration=".5s" data-wow-delay=".1s">
                        ...
                        <p>Accede a la visualización de la lista de usuarios de todo tipo...</p>
                        <Link to="/administrarcuentas" style={{ textDecoration: 'none' }}><Button type="button" className="w-75 btn BotonesColor"><FontAwesomeIcon icon={faArrowRight} /></Button></Link>
                    </div>
                </div>
            </div>
        </div>
